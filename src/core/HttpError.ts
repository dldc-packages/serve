...
import { HttpStatus, HttpStatusCode, HttpStatusMessage } from './HttpStatus';
...
interface INotAcceptable extends IHttpError {
  info: string;
}
...
interface IUnauthorized extends IHttpError {
  reason?: string;
}

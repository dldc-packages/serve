...
export type Middleware = miid.IMiddleware<ZenContext, MaybePromise<ZenResult>, Promise<ZenResponse>>;
export type Middlewares = miid.IMiddlewares<ZenContext, MaybePromise<ZenResult>, Promise<ZenResponse>>;
